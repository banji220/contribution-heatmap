export default function CTASection() {
  return (
    <section className="w-full px-6 py-20 sm:px-10 bg-background">
      <div className="mx-auto max-w-5xl text-center">
        <div className="bg-primary rounded-3xl px-8 py-14 sm:px-16 sm:py-20 relative overflow-hidden">
          {/* Decorative shapes */}
          ...
          <h2 className="text-3xl sm:text-5xl font-bold tracking-tight text-primary-foreground mb-4 animate-float-up">
            Start knocking.
          </h2>
